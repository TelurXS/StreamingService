...
public static class RemoveTitleFromList
{
	...
	{
		public Handler(ITitlesListService titlesListService, ITitleService titleService)
		{
		...
		protected override UpdateResult<Success> Handle(Request request)
		{
			...
			return TitlesListService.RemoveTitleFromList(request.TitlesListId, title);
		}
	}
}
